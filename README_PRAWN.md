...
Xem file `prawn_gem.rb` để có ví dụ đầy đủ về:
- Layout form phức tạp
- Border solid và dashed
- Text alignment và positioning
- Table với styling
- Font Unicode (Japanese)
- Field boxes với label/value
